...
extension (f: Double => Double)
  def simpson(a: Double, b: Double): Double =
    val h = (b - a) / 2
    val x0 = a
    val x1 = (a + b) / 2
    val x2 = b
